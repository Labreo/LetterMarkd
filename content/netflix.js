  ...
  if (data && data.rating && data.rating !== 'N/A') {
    ...
    ratingRow.innerHTML = `
      ...
      <div style="display:flex; gap:8px; margin-top:6px;">
        <a href="${data.url}" target="_blank" style="flex:1; background:#2c3440; color:#fff; border:none; padding:6px; border-radius:4px; font-size:11px; font-weight:bold; text-decoration:none; text-align:center; transition: background 0.2s;">+ Watchlist</a>
        <a href="${data.url}" target="_blank" style="flex:1; background:#2c3440; color:#fff; border:none; padding:6px; border-radius:4px; font-size:11px; font-weight:bold; text-decoration:none; text-align:center; transition: background 0.2s;">✓ Watched</a>
      </div>
    `;
